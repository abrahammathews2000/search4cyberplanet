# Original Code from: https://github.com/ushasi-bhowmick/alienworlds/blob/main/Sims/aliensims.py
...
# '''
# #Comment this entire section to use for other code
# Here I was just trying to figure out the working of different functions given above
