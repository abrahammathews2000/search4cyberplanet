...
# print(x, np.sqrt(1/x -1))

# ax[0][0].set_aspect("equal")
# ax[0][0].set_title('n:3')
# for c in np.array(grid):
#     rad = c[1]/grid_size
#     edgy = 1/(1+c[0]**2)
#     a = get_random_points(n=3, scale=0.9) + c
#     x,y, _ = get_bezier_curve(a,rad=rad, edgy=edgy)
#     ax[0][0].plot(x,y)
#     ax[0][0].scatter(a[:,0], a[:,1],s=6)
...
#     rad = c[1]/grid_size
#     edgy = c[0]+0.005
#     a = get_random_points(n=5, scale=0.9) + c
#     x,y, _ = get_bezier_curve(a,rad=rad, edgy=edgy)
#     ax[0][1].plot(x,y)
#     ax[0][1].scatter(a[:,0], a[:,1],s=6)

# ax[1][0].set_aspect("equal")
# ax[1][0].set_title('n:7')
# for c in np.array(grid):
#     rad = c[1]/grid_size
#     edgy = c[0]+0.005
#     a = get_random_points(n=7, scale=0.9) + c
#     x,y, _ = get_bezier_curve(a,rad=rad, edgy=edgy)
#     ax[1][0].plot(x,y)
#     ax[1][0].scatter(a[:,0], a[:,1],s=6)
...
#     rad = c[1]/grid_size
#     edgy = c[0]+0.005
#     a = get_random_points(n=15, scale=0.9) + c
#     x,y, _ = get_bezier_curve(a,rad=rad, edgy=edgy)
#     ax[1][1].plot(x,y)
#     ax[1][1].scatter(a[:,0], a[:,1],s=6)

# # plt.savefig('bezier_demo.png')
# plt.show()
